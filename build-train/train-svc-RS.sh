#!/bin/bash
#jupyter nbconvert --to notebook --execute --inplace svm/OvR/with_airport_features/svm-ovr-RS.ipynb
# jupyter nbconvert --to notebook --execute --inplace svm/OvR/with_airport_features/svm-ovr-BYS.ipynb

#jupyter nbconvert --to notebook --execute --inplace svm/OvR/no_airport_features/svm-ovr-RS.ipynb
# jupyter nbconvert --to notebook --execute --inplace svm/OvR/no_airport_features/svm-ovr-BYS.ipynb
